...
class ControladorVentas
{
	...
	/*=============================================
	   ...
	   =============================================*/
	static public function ctrSumaTVentas($fechaInicial, $fechaFinal)
	{

		$tabla = "ventas";

		$respuesta = ModeloVentas::mdlSumaTVentas($tabla, $fechaInicial, $fechaFinal);
	...
	static public function ctrMostrarAlquiler($item, $valor)
	{
		...
		$respuesta = ModeloVentas::mdlMostrarAlquiler($tabla, $item, $valor);
	...
	static public function ctrMostrarMaxCodigoVentas($item, $valor)
	{

		$tabla = "ventas";

		$respuesta = ModeloVentas::mdlMostrarMaxCodigoVentas($tabla, $item, $valor);
	...
	static public function ctrCrearVenta()
	{
		...
		if (isset($_POST["nuevaVenta"])) {
			...
			$datos = array(
				...
				"nombre_venta" => $_POST["listaNombreVenta"],
	...
	static public function ctrRenovarVenta()
	{
		...
		if (isset($_POST["nuevaVenta"])) {
			...
			if ($respuesta == "ok") {
				...
				swal({
					  type: "success",
					  title: "El alquiler ha sido renovado correctamente",
					  showConfirmButton: true,
					  confirmButtonText: "Cerrar"
					  }).then((result) => {
								if (result.value) {
