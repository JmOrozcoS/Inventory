...
$(".tablas").on("click", ".btnContactar", function () {
	...
	var mensaje = 'Hola,' + ' ' + nombre + ' ' + '¿cómo estás?. El ' + fechaFormateada + ' ha vencido tu suscripción, renueva hoy con un 10% de descuento. Puedes realizar el pago por Nequi al siguiente numero: 3122087963';
