        ...
        <div class="box box-success">
          ...
          <form role="form" method="post" class="formularioVenta">
              ...
              <div class="box">
                ...
                <div class="form-group">
                  ...
                  <div class="input-group">
                    ...
                    $ventas = ControladorVentas::ctrMostrarMaxCodigoVentas($item, $valor);
            ...
            <div class="box-footer">
              ...
              <button type="submit" class="btn btn-primary pull-right btnRventa styleVenta" id="btnRventa"
                estadoVenta="R">Guardar cambios</button>
      ...
      <div class="col-lg-7 hidden-md hidden-sm hidden-xs">
        ...
        <div class="box box-warning">
          ...
          <div class="box-body">
            ...
            <table class="table dt-responsive table-hover display tablaVentas tabla-redondeada" cellspacing="0"
              width="100%">
