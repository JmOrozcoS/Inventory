      ...
      ======================================-->
        ...
        <div class="col-lg-5 col-xs-12">
          ...
          <div class="box box-success">
            ...
            <form role="form" method="post" class="formularioSurtirInventario">
              ...
              <div class="box-body">
                ...
                <div class="box">
                  ...
                  $nombreCosto = $costo["nombre_costo"];
                  $nometodoPago = $costo["metodo_pago"];

                  /*$itemUsuario = "id";
                  $valorUsuario = $costo["id_vendedor"];
                ...
                ======================================-->
                  ...
                  <div class="form-group">
                    ...
                    <div class="input-group">
                      ...
                      <input type="text" class="form-control" id="editarCostoInventario" name="editarCostoInventario"
                        value="<?php echo $costo["codigo"]; ?>" readonly>
                ...
                ======================================-->
                  ...
                  <div class="form-group row nuevoProducto">
                    ...
                    foreach ($listaProducto as $key => $value) {
                      ...
                      $stockMenosVentas = $respuesta["ventas"];
                      ...
                      <div class="col-xs-2">
                        ...
                        <input type="number" class="form-control nuevaCantidadProducto" name="nuevaCantidadProducto" min="1" value="' . $value["cantidad"] . '" stock="' . $stockAntiguo . '" nuevoStock="' . $value["cantidad"] . '" stockVentas="' . $stockMenosVentas . '" required style="padding-left:5px" placeholder="0" style="padding-right:5px">
                            ...
                            <td style="width: 50%">
                              ...
                              <div class="input-group">
                                ...
                                <input type="text" class="form-control input-md" min="0" id="nuevoDescuentoVenta"
                                  name="nuevoDescuentoVenta" placeholder="0" value="<?php echo $porcentajeDescuento; ?>"
                                  required>
                  ...
                  <div class="form-group row">
                    ...
                    <div class="col-xs-6" style="padding-right:0px">
                      ...
                      <div class="input-group">
                        ...
                        <option value="<?php echo $nometodoPago; ?>">
                          <?php echo $nometodoPago; ?>
                        </option>
                  ...
                  <div class="form-group row">
                    ...
                    <div class="col-xs-12" style="padding-right:0px padding-left:0px">
                      ...
                      <div class="input-group">
                        ...
                        <input type="text" class="form-control input-md" id="nuevoNombreCosto" name="nuevoNombreCosto" value="<?php echo $nombreCosto ?>">
            ...
            $guardarCosto = new ControladorCostos();
            $guardarCosto-> ctrEditarCostoInventario();
